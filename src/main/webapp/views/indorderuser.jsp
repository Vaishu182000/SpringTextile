        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" style="padding-top: 20px; padding-bottom: 20px;">
                    <h2 style="text-align: center;">Products Order by You</h2>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <div class=" payment-failed-footer" style="padding-top: 30px; text-align: center;">
                <a class="btn-info btn" href="/yourOrders">Back to Orders View</a>
            </div>
        </div>